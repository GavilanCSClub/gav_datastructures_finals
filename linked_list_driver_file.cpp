...
int main()
{
    ...
    do
    {
        //PlaySound("C:\Users\Jonathan\Desktop\Final_Project_GAME\National Anthem of the soviet union_ Red Army Choir.wav", NULL, SND_FILENAME); //SND_FILENAME or SND_LOOP
        intro();
